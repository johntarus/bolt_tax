...
export default function TaxChecklistSection() {
    ...
    flex flex-col items-center justify-center">
                    ...
                    <div
                        className="lg:absolute top-0 left-0 lg:-left-8 xl:-left-16 bg-white rounded-2xl shadow-xl border border-gray-100 w-full lg:w-11/12 xl:w-7/12  max-w-sm xl:max-w-md overflow-hidden z-10 mb-8 lg:mb-0">
                        <div
